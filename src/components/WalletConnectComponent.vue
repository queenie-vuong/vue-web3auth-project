<template>
  ...
  <div v-if="!walletStore.isWeb3AuthConnected" class="bg-white rounded-lg shadow-md p-6 max-w-md mx-auto">
    ...
    <div v-else class="space-y-4">
      ...
      >
        {{ isConnecting ? 'Opening Modal...' : 'Connect with WalletConnect' }}
      </button>
      
      <div class="text-sm text-gray-600 text-center">
        <p class="mb-2">Connect using WalletConnect:</p>
        <p><strong>Wallets:</strong> MetaMask, Trust Wallet, Rainbow, Coinbase</p>
        <p><strong>Google:</strong> Social login option</p>
        <p><strong>Mobile:</strong> Scan QR code with wallet app</p>
      </div>
    </div>
